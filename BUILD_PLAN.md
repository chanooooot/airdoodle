...
1. Closed-fist-0.6s detection + ✨ button → "alive" event
...
**Verify (the delight test):** Draw a blob → hold a fist → it drops, bounces, breathes, blinks, looks at your hand. Bat it with your hand → it flies and startles. Ham grins. ≥15fps with 3 creatures. **KILL GATE: if not delightful after 2 tuning rounds, park project.**
